    ...
    <>
      ...
      <section className="section-gold-rule relative min-h-[70vh] flex items-end bg-charcoal overflow-hidden">
        <div
          ...
          aria-hidden="true"
        />
        <div className="relative z-10 w-full mx-auto max-w-site px-6 md:px-10 lg:px-16 xl:px-20 pb-20 md:pb-28 pt-40 md:pt-48">
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="font-heading font-semibold text-warm-white text-[clamp(2rem,4vw,3rem)] leading-[1.1] mb-8">
            ...
            <div>
              <p className="font-body text-grey mb-6">We primarily work with:</p>
              <ul className="space-y-0 divide-y divide-white/10">
                {clients.map((client) => (
                  <li key={client} className="flex items-center gap-5 py-4">
                    ...
                    <span className="font-body text-stone">{client}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <section className="py-28 md:py-40 bg-warm-white">
        <Container narrow>
          <div className="text-center">
            ...
            <h2 className="font-heading font-semibold text-charcoal text-[clamp(2rem,4vw,3rem)] leading-[1.1] mb-12">
            ...
            <div className="space-y-4 max-w-xl mx-auto">
              {[
                ...
                <p key={i} className="font-body text-charcoal/70 leading-relaxed text-lg">
                  {line}
                </p>
              ))}
            </div>
      ...
      <section className="py-28 md:py-40 bg-charcoal">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <ul className="space-y-0 divide-y divide-white/10 mb-10">
                {whyPoints.map((point) => (
                  <li key={point} className="flex items-center gap-5 py-5">
                    <div className="w-5 h-px bg-gold shrink-0" aria-hidden="true" />
                    <span className="font-body text-stone">{point}</span>
                  </li>
                ))}
              </ul>
              <div className="space-y-1">
                <p className="font-body font-medium text-warm-white">
